...
void Cluster::setName(int i) {
	...
	case 2:
		...
		cubes.push_back(new Cube(glm::vec4(1.0f, 1.0f, 0.0f, 1.0f), glm::vec3(0.0f, 0.0f, 0.0f)));
		cubes.push_back(new Cube(glm::vec4(1.0f, 1.0f, 0.0f, 1.0f), glm::vec3(0.0f, -1.0f, 0.0f)));
		cubes.push_back(new Cube(glm::vec4(1.0f, 1.0f, 0.0f, 1.0f), glm::vec3(0.0f, -2.0f, 0.0f)));
	...
	case 4:
		cubes.push_back(new Cube(glm::vec4(1.0f, 0.0f, 0.0f, 1.0f), glm::vec3(0.0f, 0.0f, 0.0f)));
		cubes.push_back(new Cube(glm::vec4(1.0f, 0.0f, 0.0f, 1.0f), glm::vec3(1.0f, 0.0f, 0.0f)));
		cubes.push_back(new Cube(glm::vec4(1.0f, 0.0f, 0.0f, 1.0f), glm::vec3(2.0f, 0.0f, 0.0f)));
		cubes.push_back(new Cube(glm::vec4(1.0f, 0.0f, 0.0f, 1.0f), glm::vec3(2.0f, -1.0f, 0.0f)));
		cubes.push_back(new Cube(glm::vec4(1.0f, 0.0f, 0.0f, 1.0f), glm::vec3(2.0f, -2.0f, 0.0f)));
		cubes.push_back(new Cube(glm::vec4(1.0f, 0.0f, 0.0f, 1.0f), glm::vec3(1.0f, -2.0f, 0.0f)));
		cubes.push_back(new Cube(glm::vec4(1.0f, 0.0f, 0.0f, 1.0f), glm::vec3(0.0f, -2.0f, 0.0f)));
		cubes.push_back(new Cube(glm::vec4(1.0f, 0.0f, 0.0f, 1.0f), glm::vec3(-1.0f, -2.0f, 0.0f)));
		cubes.push_back(new Cube(glm::vec4(1.0f, 0.0f, 0.0f, 1.0f), glm::vec3(-2.0f, -2.0f, 0.0f)));
		cubes.push_back(new Cube(glm::vec4(1.0f, 0.0f, 0.0f, 1.0f), glm::vec3(-1.0f, 0.0f, 0.0f)));
		cubes.push_back(new Cube(glm::vec4(1.0f, 0.0f, 0.0f, 1.0f), glm::vec3(-2.0f, 0.0f, 0.0f)));
